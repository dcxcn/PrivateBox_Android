...
import com.xunlei.aplayer.util.DisplayAreaSetUtil;
import com.xunlei.aplayer.util.UIUtil;
import com.xunlei.aplayer.view.VideoSetView;

import static com.xunlei.aplayer.play_interface.IConfigVideo.AspectRatioType.RatioNative;
import static com.xunlei.aplayer.play_interface.IConfigVideo.AspectRatioType.RationFullScreen;
...
public class ConfigVideo implements IConfigVideo {
    ...
    public void init()
    {
        ...
        mAspectRatioType = AspectRatioType.RatioNative;
    }
