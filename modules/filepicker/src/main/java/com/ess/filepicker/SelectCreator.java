...
import com.ess.filepicker.activity.SelectFolderByBrowserActivity;
...
public final class SelectCreator {
    ...
    public void start() {
        ...
        }else if (SelectCreator.this.chooseType.equals(SelectOptions.CHOOSE_TYPE_FOLDER)) {
            intent.setClass(activity, SelectFolderByBrowserActivity.class);
        } else {
            return;
        }
